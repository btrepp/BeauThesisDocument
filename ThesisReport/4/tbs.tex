...
\figuremacro{tbsdatafigure}{Structure of data payload}{Note that each byte transmitted only has seven usable bits of data, the 8th bit becomes the lowest bit in the next byte}
